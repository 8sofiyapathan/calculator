 ...
 const handleKeyDown=(e)=>{
  ...
  return (
    <div className='container border border-2 border-dark my-5'>
      <div className='my-3'>
        <input type="text" name='input' id='input' className='form-control fs-3 text-end' value={inp} onChange={(e)=>handleChange(e)} onKeyDown={e=>handleKeyDown(e)}/>
      </div>

      <div className='container'>
      <div className='row'>
          <button className='btn btn-outline-dark col m-1 fs-3' value="cls" onClick={(e)=>handleClick(e)}>cls</button>
          <button className='btn btn-outline-dark col m-1 fs-3' value="bs" onClick={(e)=>handleClick(e)}>backspace</button>
        </div>
        <div className='row'>
